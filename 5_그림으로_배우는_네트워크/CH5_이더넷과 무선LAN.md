...
- ex) 1000BASE-T
  ...
  - ![이더넷 규격](https://www.itfind.or.kr/WZIN/jugidong/931/Image2392.gif)
...
- UTP 케이블
  ...
  - 카테고리에 따라서 지원할 수 있는 주파수가 달라지고 용도나 전송속도가 정해짐
...
- 인터페이스로 무선LAN에 연결된 기기를 가리켜 무선 LAN 클라이언트라고도 자주 표현
